...
void do_array_example() {
  ...
  int numbers_size = sizeof(numbers) / sizeof(numbers[0]) ; // sizeof(numbers[0]; // expalin
...
// append - add node to tail of the list
...
void do_singly_linked_list_example() {
  ...
  cout << "[" << second->data << "," << first->next << "]" << endl; 
  ...
  // TODO prepend, proper iterative print
}